...
description := "Frequencies module of the metapi. <more documentation to come>"
...
// Play settings
// ----------------------------------------------------------------------
PlayKeys.devSettings += ("play.http.router", "frequencies.Routes")
